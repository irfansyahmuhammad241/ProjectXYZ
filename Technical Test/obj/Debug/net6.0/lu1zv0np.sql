...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20231229160821_InitialCreate') THEN
...
BEGIN
    ...
    CREATE TABLE `Companies` (
        ...
        CONSTRAINT `FK_Companies_Users_companyID` FOREIGN KEY (`companyID`) REFERENCES `Users` (`UserID`)
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    VALUES ('20231229160821_InitialCreate', '7.0.2');
